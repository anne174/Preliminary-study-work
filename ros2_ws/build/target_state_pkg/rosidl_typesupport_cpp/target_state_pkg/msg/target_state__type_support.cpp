...
static const _TargetState_type_support_symbol_names_t _TargetState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, target_state_pkg, msg, TargetState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, target_state_pkg, msg, TargetState)),
  }
};
...
{
  return &::target_state_pkg::msg::rosidl_typesupport_cpp::TargetState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, target_state_pkg, msg, TargetState)() {
  return get_message_type_support_handle<target_state_pkg::msg::TargetState>();
}
