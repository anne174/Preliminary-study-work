...
static const _TargetState_type_support_symbol_names_t _TargetState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, target_state_pkg, msg, TargetState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, target_state_pkg, msg, TargetState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, target_state_pkg, msg, TargetState)() {
  return &::target_state_pkg::msg::rosidl_typesupport_c::TargetState_message_type_support_handle;
}
