...
static const _TargetState_type_support_symbol_names_t _TargetState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, status_interfaces, msg, TargetState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, status_interfaces, msg, TargetState)),
  }
};
...
{
  return &::status_interfaces::msg::rosidl_typesupport_cpp::TargetState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, status_interfaces, msg, TargetState)() {
  return get_message_type_support_handle<status_interfaces::msg::TargetState>();
}
