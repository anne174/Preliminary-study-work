...
{
  new (message_memory) target_state_pkg::msg::TargetState(_init);
}

void TargetState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<target_state_pkg::msg::TargetState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TargetState_message_member_array[2] = {
  {
    ...
    offsetof(target_state_pkg::msg::TargetState, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(target_state_pkg::msg::TargetState, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TargetState_message_members = {
  "target_state_pkg::msg",  // message namespace
  "TargetState",  // message name
  2,  // number of fields
  sizeof(target_state_pkg::msg::TargetState),
...
get_message_type_support_handle<target_state_pkg::msg::TargetState>()
{
  return &::target_state_pkg::msg::rosidl_typesupport_introspection_cpp::TargetState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, target_state_pkg, msg, TargetState)() {
  return &::target_state_pkg::msg::rosidl_typesupport_introspection_cpp::TargetState_message_type_support_handle;
}
