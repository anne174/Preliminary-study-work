...
#include "status_interfaces/msg/detail/target_state__rosidl_typesupport_fastrtps_c.h"
...
using _TargetState__ros_msg_type = status_interfaces__msg__TargetState;
...
size_t get_serialized_size_status_interfaces__msg__TargetState(
  const void * untyped_ros_message,
...
static uint32_t _TargetState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_status_interfaces__msg__TargetState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_status_interfaces
size_t max_serialized_size_status_interfaces__msg__TargetState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = status_interfaces__msg__TargetState;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
static size_t _TargetState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_status_interfaces__msg__TargetState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, status_interfaces, msg, TargetState)() {
