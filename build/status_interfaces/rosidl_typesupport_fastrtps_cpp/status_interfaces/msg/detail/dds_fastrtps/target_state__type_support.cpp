...
#include "status_interfaces/msg/detail/target_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const status_interfaces::msg::TargetState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  status_interfaces::msg::TargetState & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = status_interfaces::msg::TargetState;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const status_interfaces::msg::TargetState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<status_interfaces::msg::TargetState *>(
    untyped_ros_message);
...
{
  return &status_interfaces::msg::typesupport_fastrtps_cpp::_TargetState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, status_interfaces, msg, TargetState)() {
  return &status_interfaces::msg::typesupport_fastrtps_cpp::_TargetState__handle;
}
