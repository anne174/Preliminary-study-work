...
#include "target_state_pkg/msg/detail/target_state__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = target_state_pkg::msg::TargetState;
    is_plain =
      (
      offsetof(DataType, y) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const target_state_pkg::msg::TargetState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<target_state_pkg::msg::TargetState *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_target_state_pkg
const rosidl_message_type_support_t *
get_message_type_support_handle<target_state_pkg::msg::TargetState>()
{
  return &target_state_pkg::msg::typesupport_fastrtps_cpp::_TargetState__handle;
}
